//INT Inference NOT tested on large scale
...
#ifndef MNET_INT_DWSCONV_H
#define MNET_INT_DWSCONV_H
	...
	for(int cout_n=0;cout_n<CONFIG_C::CHout;cout_n++)
	{
		for(int i=0;i<CONFIG_C::Hout;i++)
		{
			for(int j=0;j<CONFIG_C::Wout;j++)
			{
                ...
                =(typename CONFIG_C::Dtype_f)sum/CONFIG_C::Delta_w;
			}
		}
	}
};
    ...
    )
{
    for(int i=0;i<CONFIG_C::Hout;i++)
    {
        for(int j=0;j<CONFIG_C::Wout;j++)
        {
            ...
            for(int cin_n=0;cin_n<CONFIG_C::CHin;cin_n++){DW_out_ij[cin_n]=bias_DW[cin_n]/CONFIG_C::Delta_w;}
                ...
                for(int jj=0;jj<CONFIG_C::Kw;jj++)
                {
                    ...
                    if(h>=0 && w>=0 && h<CONFIG_C::Hin && w<CONFIG_C::Win)
                    {
                        ...
                        for (int cin_n=0;cin_n<CONFIG_C::CHin;cin_n++)
                        {
                            ...
                            W_DW[cin_n*1*CONFIG_C::Kh*CONFIG_C::Kw+ 0 +ii*CONFIG_C::Kw+jj]/CONFIG_C::Delta_w;
                        }
                    }
                }
            }
            ...
            for(int cout_n=0;cout_n<CONFIG_P::CHout;cout_n++){
                feature_out[cout_n*CONFIG_P::Hout*CONFIG_P::Wout+i*CONFIG_P::Wout+j]=bias_PW[cout_n]/CONFIG_P::Delta_w;
                for (int cin_n=0;cin_n<CONFIG_P::CHin;cin_n++){
                    feature_out[cout_n*CONFIG_P::Hout*CONFIG_P::Wout+i*CONFIG_P::Wout+j]
                    +=DW_out_ij[cin_n]*W_PW[cout_n*CONFIG_P::CHin  +  cin_n]/CONFIG_P::Delta_w;
                }
